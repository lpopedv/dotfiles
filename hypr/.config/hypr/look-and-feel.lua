hl.config({
    general = {
        ...
        col = {
            active_border   = { colors = { "rgba(ffffffff)", "rgba(5a5a5aff)", "rgba(ffffffff)" }, angle = 45 },
...
hl.animation({ leaf = "windowsIn",     enabled = true, speed = 3.5,  bezier = "easeOutQuint", style = "popin 94%" })
hl.animation({ leaf = "windowsOut",    enabled = true, speed = 2.2,  bezier = "easeInQuint",  style = "popin 96%" })
